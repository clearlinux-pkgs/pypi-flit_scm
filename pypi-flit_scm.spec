...
Version  : 1.6.1
Release  : 7
URL      : https://files.pythonhosted.org/packages/13/bd/1954d91d661a0f0bf1ef3893064350a22b3fdd9b15ef7091c97df13d76d7/flit_scm-1.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/13/bd/1954d91d661a0f0bf1ef3893064350a22b3fdd9b15ef7091c97df13d76d7/flit_scm-1.6.1.tar.gz
...
%prep
%setup -q -n flit_scm-1.6.1
cd %{_builddir}/flit_scm-1.6.1
pushd ..
cp -a flit_scm-1.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653846936
...
cp %{_builddir}/flit_scm-1.6.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-flit_scm/29d3d7ebffdf889087bab0aad8b77f98e0beb6d9
